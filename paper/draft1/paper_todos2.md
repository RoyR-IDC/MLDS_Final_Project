...
- [V] do a VERY MINIMAL update (because it is currently very good as it is) - talk about the 3 models being from 3 different compared families - CNN, transformers, MLP ...
...
- [V] switch sub sections 2.5 and 2.6 for better logical reading flow
...
- [V] split into sub sections in a similar manner as in section 4 (methodology)

- [V] explain how data is resized, to what size. (in future sections, maybe talk about what the resize what affect)

- [V] rephrase "use the same 4 × 3 grid-permutation matrix" as it is confusing with the grid sizes themselvs.

- [V] (!) show example fo the grids and permutations - same as is the hardness section (and also there - need to put images in 3 rows) (this might require updating and re-running notebook part 3)
...
- [V] show all main experiment graphs. missing: 2 graphs from part 1 reviewer controlled experiment reuests  (should be referenced in 7.1). also missing, all graphs of part 3 hardness metrics

- [V] dont show 3d graphs, not even in additional info

- [V] the results themselves are not written in texts or analyzed.

- [V] need to updare results


Discussion:

- [V] make sure the general concepts of the introduction are mentioned here as well.


References:

- [V] make sure links are valid and not broken.


General:

- [V] make sure only latest results used
